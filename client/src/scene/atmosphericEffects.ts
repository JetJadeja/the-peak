 ...
 */
export function applyClearDayPreset(scene: THREE.Scene, skyMesh: THREE.Mesh): void {
 ...
 */
export function applyGoldenHourPreset(scene: THREE.Scene, skyMesh: THREE.Mesh): void {
 ...
 */
export function applyMistyMorningPreset(scene: THREE.Scene, skyMesh: THREE.Mesh): void {
  updateFogDensity(scene, 0.020); // Dense fog
